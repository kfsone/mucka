...
/// becomes JSON each of those high bytes costs six characters (<c>ÿ</c>). Measured over the
/// owner's 40 existing session recordings: 6.1 MB of actual payload became 17.2 MB of .jsonl, a 2.8x
/// tax paid entirely on escaping. Sinks that need text decode at the edge; storage never does.</para>
///
