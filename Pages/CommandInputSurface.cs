...
/// it is four one-line members long so that there is nowhere in it for a mistake to hide.</para>
///
/// <para><b>Rules for this file:</b> each member is a direct property get/set and nothing else. No
/// measuring, no <c>UpdateLayout</c>, no scrolling, no scheduling, no conditionals beyond a null
/// check, no logging. Work belongs on the far side of <see cref="Mucka.Input.InputGate"/>, which is
/// reachable from everywhere that legitimately needs it.</para>
///
...
/// torn-down WinUI visual, an RO_E_CLOSED crash.</para>
/// </summary>
