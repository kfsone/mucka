...
///
/// Clio colour-constant → AnsiColor mapping:
...
public class Mud2C1Tests
{
    ...
    public void C98_SetsColor_AndSetsPromptAllowed()
    {
        ...
        // Text emitted after C98 should carry the BLACK/BLUE colour.
    ...
    // ── Gap 1: bare FF FF pops colour stack ───────────────────────────────────

    [Fact]
    public void BareC255_PopsColourStack()
    {
    ...
    public void C89_F4_UnrecognisedPayload_WaitsForTerminator()
    {
        ...
        // The sequence should NOT dispatch early; text after FF FF should be in the applied colour.
        var h = new ParserHarness();
