...
public sealed class MudSessionOptions
{
    ...
    /// command ("dr t") delivers every "X dropped." line in one server frame - one captured clog
    ...
    /// carry the probe out with it (MudSession.SendLine). Default: 100ms.
    /// </summary>
    ...
    /// is moved to the far side of the boundary instead. Default: 200ms.
    /// </summary>
    ...
    /// error, which fits a whole session to a ~26ms median residual. Default: 50ms.
    /// </summary>
